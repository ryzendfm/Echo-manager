...
import { Phone, Link2, CalendarIcon, Clock } from "lucide-react";
...
export default function UpcomingForwardCalls() {
    ...
    useEffect(() => {
        const fetchCalls = async () => {
            try {
                const res = await forwardCallApi.getMyForwardCalls({ status: "scheduled" });
                const sorted = (res.data.forwardCalls || [])
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Your scheduled calls with the team</CardDescription>
                </CardHeader>
                <CardContent>
                                    ...
                                    <div key={fc.id}>
                                        ...
                                        >
                                            <div className="flex items-center justify-between gap-2">
                                                <span className="font-medium text-sm truncate">{fc.title}</span>
